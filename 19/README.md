...
The press was founded by Rev. Charles Lacey, who brought a hand-operated letterpress from England. [Orissa Mission Press]([url](https://bl.iro.bl.uk/concern/articles/e922a7fa-e9a4-4686-a2cd-dc34cfd6c9f5)) was the first modern printing press of Orissa (presently, Odisha). Chapakala19 revives a workhorse typeface designed by Manohar Karmakar, son-in-law of Panchanan Karmakar, both goldsmiths and type designers. Panchanan is credited with designing the first typefaces for most major South Asian writing systems, including the type used for the first _Oriya_ [[1]](#1) book, the New Testament, printed at the Serampore Mission Press in 1811.  Manohar built on Panchanan’s work, adapting his knowledge from other South Asian scripts.
...
# What this font is for​

Chapakala19 revives historical Odia letterforms, details, and _juktaksharas_ (consonant cluster) of the 19th century, allowing users to retype, reprint, or visually reference letterpress-era texts without losing their original texture. You can use it for faithful editions of older works, for everyday reading typography, or as a base font when training OCR models on scanned Odia books.​

We focus on copy fonts used across nearly the early 100 years of Oriya print, starting from 1807, prioritising body text over display styles. The design aims for historical fidelity while remaining useful for long‑form reading and digital interfaces. However, this is a fine balance, and Chapakala19 leans more towards preserving the original style.

The font is engineered as a standards‑compliant OpenType family using Unicode, so it works with modern text engines on current operating systems without special keyboard layouts or legacy encodings. We will continue expanding coverage and publishing _juktakshara_ lists over time, and we invite your feedback about missing shapes or variants from specific editions.
...
You install Chapakala19 like any other desktop font: download the release files from the repository, install them on your operating system, and then select the font in your layout, word‑processing, or design software. You can keep using your existing Odia input method; conjuncts and other forms will be handled by the font’s OpenType layout, where supported by your software.

You can mix Chapakala with Latin typefaces as you would with any other Odia Unicode font in documents, web pages, books, and visual media.

## Use
Install `.ttf` or `.otf` from `fonts/` folder.  

## OCR Training
If you plan to use it for OCR training or testing, you can generate synthetic pages in this font to match letterpress‑style shapes and then pair them with ground‑truth text for your models.
...
We release Chapakala as a free and open font under the SIL Open Font License 1.1, with source files under CC BY‑SA 4.0 International License to support reuse, study, and adaptation. You can embed the font, redistribute it under the OFL terms, and build tooling or research workflows around it without separate permission.

Note that this is an ongoing project: we intend to refine shapes, expand the glyph set, and add additional historical styles as separate fonts in the family. You can report issues, share examples of historical material that does not yet render as expected, or propose changes through the repository, helping us improve Chapakala for both readers and machines.
...
## 2026 (Phase 2)
- Add another font from Oriya letterpress widely used in the 1900s.
...
# Support
The first phase of Chapakala19 was generously supported by the [Samagata Foundation]([url](https://samagata.org/)).

![Samagata_logo](https://github.com/user-attachments/assets/c796ecaa-1197-4483-9f48-211706c06bac)<?xml version="1.0" encoding="UTF-8"?>
...
We remain open to further support as we plan to expand to more typefaces of different eras. Please [write to us]([url](https://theofdn.org/reach-out/)) to support.
